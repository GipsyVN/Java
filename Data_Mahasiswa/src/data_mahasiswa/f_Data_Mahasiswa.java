...
public class f_Data_Mahasiswa extends javax.swing.JFrame {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        no = RowSelect.get_no();
        String nim = txtNIM.getText();
        String nim1 = (String) tb.getValueAt(i, 1);
        String nama = txtNama.getText();
        String nama1 = (String) tb.getValueAt(i, 2);
        String tempat = txtTempat.getText();
        String tempat1 = (String) tb.getValueAt(i, 3);
        Date tanggal = dtTanggal.getDate();
        Date tanggal1 = (java.util.Date) tb.getValueAt(i, 4);
        String prodi = txtProdi.getText();
        String prodi1 = (String) tb.getValueAt(i, 5);
        String asal = txtAsal.getText();
        String asal1 = (String) tb.getValueAt(i, 6);
        String alamat = txtAlamat.getText();
        String alamat1 = (String) tb.getValueAt(i, 7);
        
        
        if(nim.equals(nim1) && nama.equals(nama1) && tempat.equals(tempat1) && tanggal.equals(tanggal1) && prodi.equals(prodi1) && asal.equals(asal1) && alamat.equals(alamat1)){
            JOptionPane.showMessageDialog(null, "Tidak Ada Data Yang Diubah");
        }else if(nim.isEmpty() || nama.isEmpty() || tempat.isEmpty() || tanggal == null || prodi.isEmpty() || asal.isEmpty() || alamat.isEmpty()){
            JOptionPane.showMessageDialog(null, "Data Tidak Lengkap\nSilahkan Isi Data Secara Lengkap");
        }else{
